...
inputs:
  - name: focus
    type: string
    required: false
    description: Optional emphasis ("secrets", "validation", "ci"). When omitted, all four areas are covered.

outputs:
  - name: report
    type: markdown
    description: Findings + concrete next actions, grouped by .env hygiene, documentation, validation, and CI/CD.
