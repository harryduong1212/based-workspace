...
id: pr-review-prep
name: PR Review Prep
description: Generate a structured review brief for a Bitbucket pull request, with the linked ticket context and past reviewer feedback already pulled in.
audience: tech
version: 0.1.0
status: experimental
cost: low
...
triggers:
  cli: pr-review-prep
  chat:
    - "prep review for PR-NNN"
    - "review brief for PR NNN"

inputs:
  - name: pr_id
    type: string
    required: true
    description: Bitbucket PR ID (e.g., 287).

outputs:
  - name: review_brief
    type: markdown
    description: Structured review notes — what to focus on, what looks risky, what's already been raised.
