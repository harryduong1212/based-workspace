...
argument-hint: [--input file=<value>]
---

<!-- Generated from recipes/git-conflict.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_claude_code.py`. -->
