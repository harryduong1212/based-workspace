...
argument-hint: [--input base=<value>] [--input goal=<value>]
---

<!-- Generated from recipes/git-rebase.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_claude_code.py`. -->
