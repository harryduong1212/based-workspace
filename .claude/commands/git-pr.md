...
argument-hint: [--input target_branch=<value>] [--input issue_number=<value>]
---

<!-- Generated from recipes/git-pr.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_claude_code.py`. -->
