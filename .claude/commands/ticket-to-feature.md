...
argument-hint: --input ticket_key=<value>
---

<!-- Generated from recipes/ticket-to-feature.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_claude_code.py`. -->
