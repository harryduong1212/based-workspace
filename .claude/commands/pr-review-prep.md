...
argument-hint: --input pr_id=<value>
---

<!-- Generated from recipes/pr-review-prep.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_claude_code.py`. -->
