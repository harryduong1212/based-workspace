...
<!-- Generated from recipes/git-conflict.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run git-conflict`
- Chat: "resolve merge conflicts", "help with merge conflict", "git conflict"
