...
<!-- Generated from recipes/smoke-agent.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run smoke-agent`
- Chat: "smoke agent", "test agent dispatch"
