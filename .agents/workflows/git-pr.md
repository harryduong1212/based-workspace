...
> Draft a pull request title and description from the current branch's commits and diff against a target branch.

<!-- Generated from recipes/git-pr.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run git-pr`
- Chat: "draft a PR description", "create pull request description", "git pr"
