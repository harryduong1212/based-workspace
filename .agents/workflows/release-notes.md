...
> Generate release notes for a tag-to-tag (or tag-to-HEAD) range — classified into Features, Fixes, Breaking changes, and the rest, ready to paste into GitHub/GitLab.

<!-- Generated from recipes/release-notes.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run release-notes`
- Chat: "draft release notes", "changelog since", "release notes for"
