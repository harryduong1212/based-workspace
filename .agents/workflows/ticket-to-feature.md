...
<!-- Generated from recipes/ticket-to-feature.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run ticket-to-feature`
- Chat: "spec out PROJ-XXX", "feature kickoff for PROJ-XXX", "turn this ticket into a feature"
