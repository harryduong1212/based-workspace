# E1 dispatcher smoke test

> Minimal prompt recipe used by validate.py to confirm dispatch_prompt is wired (no [STUB]) and to sanity-check the local LLM endpoint.

<!-- Generated from recipes/test-prompt.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run test-prompt`
