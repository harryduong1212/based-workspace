...
<!-- Generated from recipes/pr-review-prep.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run pr-review-prep`
- Chat: "prep review for PR-NNN", "review brief for PR NNN"
