...
> Group staged changes into logical commits and draft Conventional Commits messages, ready to apply.

<!-- Generated from recipes/git-commit.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run git-commit`
- Chat: "draft a commit message", "git commit", "commit my changes"
