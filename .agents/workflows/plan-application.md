...
<!-- Generated from recipes/plan-application.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run plan-application`
- Chat: "plan a new application", "design a new app"
