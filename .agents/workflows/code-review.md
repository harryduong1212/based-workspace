...
<!-- Generated from recipes/code-review.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run code-review`
- Chat: "review this code", "code review", "review my changes"
