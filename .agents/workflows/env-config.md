...
<!-- Generated from recipes/env-config.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run env-config`
- Chat: "audit env config", "check environment variables"
