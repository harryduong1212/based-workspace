# Assess Workspace State

> Heuristically assess any repository — features, tech stack, infrastructure, security — into a maintained six-doc set plus a prioritized next-steps list, with drift surfaced on re-run.

<!-- Generated from recipes/assess-workspace.md. Do not edit directly — edit the source recipe and re-run `python scripts/sync_antigravity.py`. -->

## How to invoke

- CLI: `python scripts/recipe_manager.py run assess-workspace`
- Chat: "assess this workspace", "what's the state of this project"
