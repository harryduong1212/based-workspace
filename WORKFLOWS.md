...
| Workflow | Command | Status | Description |
|---|---|---|---|
| [ai-agent](.archived/workflows/ai-llm/ai-agent.md) | /ai-agent | ✅ Ready | Create AI agents with tools |
| [prompt-engineering](.archived/workflows/ai-llm/prompt-engineering.md) | /prompt-engineering | ✅ Ready | Design and optimize LLM prompts |
| [rag-pipeline](.archived/workflows/ai-llm/rag-pipeline.md) | /rag-pipeline | ✅ Ready | Build retrieval-augmented generation |
