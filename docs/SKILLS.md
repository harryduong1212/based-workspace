...
| [n8n-atom-executor](.archived/skills/workflow-automation-platforms/n8n-atom-executor/SKILL.md) | Executes n8n-atom automated workflows and integrates with the MCP inspector bridge. |
