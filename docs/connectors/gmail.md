...
> Google Mail mailbox access via IMAP for daily-briefing and inbox-aware recipes.
>
> **Status:** experimental · **Auth:** basic

| | |
|---|---|
| **Provides** | messages, threads, labels |
| **Required env vars** | `GMAIL_ADDRESS`, `GMAIL_APP_PASSWORD` |
| **n8n workflow** | `n8n-workflows/connectors/gmail.n8n` |
