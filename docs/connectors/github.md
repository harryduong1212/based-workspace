...
> GitHub.com source code, pull requests, issues, and review queue.
>
> **Status:** experimental · **Auth:** api_token

| | |
|---|---|
| **Provides** | pull_requests, issues, repositories, review_requests |
| **Required env vars** | `GITHUB_TOKEN` |
| **n8n workflow** | `n8n-workflows/connectors/github.n8n` |
