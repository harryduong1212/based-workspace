...
| **Skills loaded** | `workspace-state-assessment`, `codebase-cleanup-deps-audit`, `security-audit` |
| **Triggers** | CLI: `assess-workspace` · Chat: "assess this workspace", "what's the state of this project" |
